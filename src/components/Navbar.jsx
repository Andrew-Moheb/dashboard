...
import { Cart, Chat, UserProfile, Notifications } from ".";
...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between p-1 md:ml-6 md:mr-6 w-full">
      <NavButton
        title="Menu"
        ...
        <TooltipComponent content="Profile" position="BottomCenter">
          ...
          >
            ...
            <p>
              ...
              <span className="text-gray-400 font-bold ml-1"> Andrew</span>
            </p>
